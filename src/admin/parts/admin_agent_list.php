<section style="margin:0 50px;">
    ...
    $agent_list_array = [
        ...
        ['サンプル企業名5', 'サンプル契約日5', 'サンプル学生人数5', 'サンプル請求額5','サンプルメールアドレス4'],
        ['サンプル企業名6', 'サンプル契約日6', 'サンプル学生人数6', 'サンプル請求額6','サンプルメールアドレス4'],
        ['サンプル企業名7', 'サンプル契約日7', 'サンプル学生人数7', 'サンプル請求額7','サンプルメールアドレス4'],
    ];
    $agents_per_page=2;
    ...
    for($agent_index=0+($page_number-1)*$agents_per_page;$agent_index<$agents_per_page*$page_number;$agent_index++) {
        if($agent_index+1<=count($agent_list_array)){
            echo '<div id="test'.$agent_index.'" style="display:flex;background-color:blue;margin-bottom:50px;">';
